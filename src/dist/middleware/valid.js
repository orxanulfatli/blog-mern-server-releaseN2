...
exports.validCategory = exports.validateEmail = exports.validPhone = exports.validRegister = void 0;
...
const validCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { name } = req.body;
        const errors = [];
        //validate name
        ...
        if (errors.length > 0)
            throw apiErrors_1.ApiError.BadRequest('some', errors);
        next();
    }
    catch (error) {
        next(error);
