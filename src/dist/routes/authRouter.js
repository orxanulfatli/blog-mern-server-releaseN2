...
router.post('/active', authCtrl_1.default.activateAccount);
...
router.post('/login_sms', authCtrl_1.default.sendOTP);
router.post('/sms_verify', authCtrl_1.default.verifyOTP);
